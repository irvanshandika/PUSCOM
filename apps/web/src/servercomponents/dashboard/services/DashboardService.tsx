...
export default function ServiceDashboardPage() {
  ...
  const ServiceTable = ({ status }: { status?: string }) => {
    const filteredServices = status
      ...
      : services.filter((service) => !["completed", "rejected"].includes(service.status));
            ...
            <TableRow key={service.id}>
              ...
              <TableCell>
                <Select
                  ...
                  disabled={service.status === "rejected" || service.status === "completed"}
                >
              ...
              <TableCell>
                {format(new Date(service.date), "dd MMMM yyyy", { locale: id })}
              </TableCell>
                ...
                {selectedService.brand && (
                  <div>
                    ...
                    <p className="font-medium">
                      {selectedService.brand === "Others"
                        ? selectedService.customBrand
                        : selectedService.brand}
                    </p>
                  </div>
                )}
      ...
      <AlertDialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Mohon berikan alasan penolakan service ini:
            </AlertDialogDescription>
          </AlertDialogHeader>
          <Textarea
            value={rejectReason}
