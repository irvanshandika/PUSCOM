        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 lg:gap-12">
          ...
          <div className="flex-1 space-y-6 sm:space-y-8 text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white leading-tight">
              Solusi Digital untuk Kebutuhan Komputer Anda
            </h1>
            <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto lg:mx-0">
              PUSCOM menyediakan layanan jual beli komputer & laptop, servis, dan spare part berkualitas dengan harga terbaik.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Link 
                href="/service" 
                className="px-6 py-3 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900 transition duration-300 text-center"
              >
                Layanan Servis
              </Link>
            </div>
