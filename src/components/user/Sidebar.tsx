        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto py-4 px-4">
            <div className="space-y-6">
              ...
              <div>
                <div className="px-3 mb-2 text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Finance</div>
                <div className="space-y-1">
              ...
              <div>
                <div className="px-3 mb-2 text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Team</div>
                <div className="space-y-1">
